$(document).ready(function() {
  ...
  function addTableRow(className, dish) {
    var template = '<tr class="menu-row">';
  ...
  function getPictureHtml(picture) {
    if (picture) {
      return '<td><img src="' + picture + '" width=250 height=150></td>';
    } else {
      return '<td><img src="/static/img/no_img.svg" width=250 height=150></td>';
    }
  }
});
